...
import { useGetAllCategory, useGetAllNation, useGetAllSongs, useGetAllTopic } from '../../hook';
...
function SongTrash() {
  ...
  const songs = useGetAllSongs(10, currentPage - 1, searchValue, name, sort, 1, valueChange, value);
  ...
  }, [songs.isError, updateTrashSong.isError, deleteSong.isError]);
  useEffect(() => {
